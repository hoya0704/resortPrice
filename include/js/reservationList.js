var objReservationListAjax={},
        objReservationListEvent = {};
/* */
objReserveListEvent = {
...
$(document).ready(function () {
    ...
    $('#cbo_area').attr('disabled', true);
    $('#cbo_resort').attr('disabled', true);    
    $('#cbo_nation').bind('change', objReservationListAjax.changeCboNation);             //국가선택  
    $('#cbo_area').bind('change', objReservationListAjax.changeCboArea);                    //지역선택 
