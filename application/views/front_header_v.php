		...
		?>
			...
			<nav id="gnb">		<!--gnb Start -->	
				<div class="menu">
					...
					<ul>
						<li><a href="/index.php/reservation/write">예약하기</a></li>	
						<li><a href="/index.php/reservation/lists">예약목록</a></li>
...
<!--
			...
			<div class="menu">
				<h1><img src="/resortPrice/CI/include/images/top_logo.jpg"></h1>
				<ul>
					<li><a href="/resortPrice/CI/index.php/member/">회원관리</a></li>	
					<li><a href="/resortPrice/CI/index.php/resort/">리조트관리</a></li>
					<li><a href="/resortPrice/CI/index.php/reservation/">예약관리</a></li>
					<li><a href="/resortPrice/CI/index.php/board/lists/BOARD/">게시판관리</a></li>
				</ul>
			</div>
-->