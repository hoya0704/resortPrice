 ...
 <select style="width:200px"><option>선택</option></select></td>
						</tr>
						<tr>
							<th>식사/객실수</th>
							<td><select style="width:200px"><option>선택</option></select> <select style="width:100px"><option>1</option></select></td>
						</tr>
						<tr>
							<th>체크인</th>
						...
						<tr>
							<th>숙박일</th>
							<td><select style="width:100px"><option></option></select> 박 (선택 시 체크아웃날짜가 자동으로 계산됩니다.)</td>
						</tr>
						<tr>
							<th rowspan="3">주소</th>
    ...
    <!-- javascript 영역 -->
  <script src="<?php echo JS_ROOT?>/reservationView.js"></script> 
